    ...
    <div class="relative mx-auto max-w-2xl py-24 sm:py-32 lg:max-w-4xl">
        ...
        <figure class="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
            <div class="relative col-span-2 lg:col-start-1 lg:row-start-2">
                ...
                <blockquote class="text-xl font-normal leading-8 text-gray-900 sm:text-2xl sm:leading-9">
                    <p>
                        Sebagai seorang Laravel Enthusiast, saya memiliki minat yang besar dalam mengembangkan aplikasi
                        web dengan menggunakan framework Laravel. Saya sangat terpesona dengan potensi yang dimiliki
                        oleh Laravel dan selalu bersemangat untuk mempelajari dan mengembangkan aplikasi web yang lebih
                        baik dengan menggunakan framework tersebut.
                    </p>
                </blockquote>
            </div>
            <div class="col-end-1 w-16 lg:row-span-4 lg:w-72">
                <img class="rounded-xl bg-indigo-50 lg:rounded-3xl" src="../assets/images/photo.jpeg" alt="Photo">
            </div>
        </figure>
    </div>
</section>
